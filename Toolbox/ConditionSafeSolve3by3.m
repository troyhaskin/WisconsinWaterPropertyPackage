function x = ConditionSafeSolve3by3(A,b)
    ...
    % Form the inverse
    InvAp = AdjAp/DetAp; % Already have the adjoint, might as well use it.
...
function Orth = GetOrthogonalVector(ParallelRow)
    ...
    OrthPrime = (2*rand(1,N-1)-1) .* norm(ParallelRow(Mask),2);
